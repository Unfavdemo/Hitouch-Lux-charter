      ...
      <Container>
        <div className="max-w-2xl">
          ...
          <h2 className="mt-4 font-serif text-3xl font-normal tracking-tight text-light-ink sm:text-4xl">
            One relationship. Every kind of movement.
          </h2>
          <p className="mt-4 text-sm leading-relaxed text-light-muted sm:text-base">
            Game days, memberships, executive programs, and airport rituals—each handled on one
            concierge thread from first call to final door.
          </p>
        </div>
