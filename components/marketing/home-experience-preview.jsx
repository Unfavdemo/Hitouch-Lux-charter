...
export function HomeExperiencePreview({ experiences }) {
  return (
          ...
          {experiences.map((experience) => (
            ...
            >
              <div className="relative aspect-[5/4] w-full overflow-hidden">
                ...
                <span
                  className="absolute left-4 top-4 text-[10px] font-semibold uppercase tracking-[var(--tracking-brand)] text-accent-readable/80"
                  aria-hidden
                >
                  {experience.categoryDisplayName}
                </span>
