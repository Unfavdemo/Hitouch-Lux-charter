  ...
  return (
    <>
      <div className="pointer-events-none fixed bottom-6 right-6 z-[60] flex flex-col items-end gap-3 sm:bottom-8 sm:right-8">
        <div
          className={`pointer-events-auto w-[min(100vw-3rem,22rem)] origin-bottom-right transition ${
      ...
      >
        ...
        <div
          ...
          className={`absolute right-0 top-0 flex h-full w-full max-w-md flex-col border-l border-border-subtle bg-page shadow-2xl transition-transform duration-300 ${
        ...
        >
          ...
          <div className="flex-1 space-y-6 overflow-y-auto px-5 py-6 text-sm text-muted">
            <div>
